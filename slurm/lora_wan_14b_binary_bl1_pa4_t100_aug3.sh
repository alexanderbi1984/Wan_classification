#!/bin/bash -l
#SBATCH --job-name=WanLoRA14B_bin_bl1pa4_t100aug3
...
echo "[$(date +%T)] Experiment: Binary BL1 vs PA4 — t100 + aug3 + CORAL"
echo "[$(date +%T)] Config: config_pain/config_lora_binary_bl1_pa4_t100_aug3.yaml"
echo "[$(date +%T)] Previous best: QWK=0.468 (t=0, aug2, CE)"

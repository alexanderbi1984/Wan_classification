#!/bin/bash -l
#SBATCH --job-name=WanLoRA14B_bin_res256_spattn
...
echo "[$(date +%T)] Experiment: Binary BL1vPA4 t100+aug3+res256 + Spatial Attention Pooling"
echo "[$(date +%T)] Config: config_pain/config_lora_binary_bl1_pa4_t100_aug3_res256_spattn.yaml"

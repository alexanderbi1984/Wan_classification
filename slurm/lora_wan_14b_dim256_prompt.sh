#!/bin/bash -l
#SBATCH --job-name=WanLoRA14B_dim256_prompt
...
echo "[$(date +%T)] Experiment: dim256 + aug2 + T5 prompt conditioning"
echo "[$(date +%T)] Config: config_pain/config_lora_dim256_prompt.yaml"

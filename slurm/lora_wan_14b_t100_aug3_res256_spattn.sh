#!/bin/bash -l
#SBATCH --job-name=WanLoRA14B_res256_spattn
...
echo "[$(date +%T)] Experiment: 5-class t100+aug3+res256 + Spatial Attention Pooling"
echo "[$(date +%T)] Config: config_pain/config_lora_t100_aug3_res256_spattn.yaml"
